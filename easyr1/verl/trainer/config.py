...
class DynamicSamplingConfig:
    enable: bool = False          # 是否启用动态采样
    metric: str = "seq_final_reward"  # 用于过滤的指标名称
    min_std: float = 0.1         # 最小标准差阈值
    max_num_gen_batches: int = 3 # 最大生成批次尝试次数
...
class AlgorithmConfig:
    ...
    kl_target: float = 0.0
    dynamic_sampling: DynamicSamplingConfig = field(default_factory=DynamicSamplingConfig)  # 修改这行
